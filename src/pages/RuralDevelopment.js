                ...
                >
                  <div className="relative group">
                    <div className="overflow-hidden rounded-xl shadow-xl">
                      <img
                        src={section.image}
                        alt="Acid Attack Survivors Support"
  ...
  return (
    <div>
      ...
      <section className="w-full bg-white py-2 sm:py-4 overflow-x-hidden">
       ...
       We at RUDRAKSHA, are working under the <strong>Project Name "VIKRIT VAIDHARMYA"</strong> under the <strong>Project Head "GRACIOUS JUSTICE"</strong>, to provide medical and emotional physiological support for Acid Survivors. An acid attack, also called acid throwing, vitriol attack, or vitriol age, is a form of violent assault involving the act of throwing acid or a similarly corrosive substance onto the body of another "with the intention to disfigure, maim, torture, or kill". The most common types of acid used in these attacks are sulfuric and nitric acid. Hydrochloric acid is sometimes used, but is much less damaging. Aqueous solutions of strongly alkaline materials, such as caustic soda (sodium hydroxide), are used as well, particularly in areas where strong acids are controlled substances. The long-term consequences of these attacks may include blindness, as well as eye burns, with severe permanent scarring of the face and body, along with far-reaching social, psychological, and economic difficulties.</p>
          </div>
        </div>
      </section>  
